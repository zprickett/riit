...
<div class="content-slider cols-wrapper cols-2" id="<?php echo $slider_div_id; ?>" >
	...
	<ul id="cs-slider-ul" style="min-height:<?php echo $slider_height; ?>px;">
		...
		$data_keys = array('layout', 'animation', 'bg_color', 'text_color', 'bg_image_url', 'bg_image_opacity', 'image_url', 'main_title', 'small_title', 'description', 'but_one_text', 'but_one_link', 'but_two_text', 'but_two_link');
		...
		foreach ( $slider_items as $item ) {
			...
			<?php 
				...
				$img_class = "cs-content-";

				if($slide_layout=='centered'){
					$content_class.='centered';
				}elseif($slide_layout=='img-text'){
					$content_class.='right';
					$img_class.='left';
				}elseif($slide_layout=='text-img'){
					$content_class.='left';
					$img_class.='right';
				}
			 ?>
				...
				<div class="<?php echo $img_class; ?> col nomargin">
					<?php 
					if(!empty($imgurl)){ ?>
