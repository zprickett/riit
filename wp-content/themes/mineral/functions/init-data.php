		...
		$pexeto->custom_pages=array( PEXETO_NIVOSLIDER_POSTTYPE=>
			...
			new PexetoCustomPage( PEXETO_CONTENTSLIDER_POSTTYPE, array(
					array( 'id'=>'layout', 'type'=>'select', 'name'=>'Slide Layout', 'two-column'=>'first', 'options'=>array(
						array('id'=>'centered', 'name'=>'Centered Text', 'hide'=>PEXETO_CUSTOM_PREFIX.'image_url'), 
						array('id'=>'img-text', 'name'=>'Text on the right'),
						array('id'=>'text-img', 'name'=>'Text on the left'))),
					...
					array( 'id'=>'bg_image_opacity', 'type'=>'select', 'name'=>'Background Image Opacity', 'options'=>$opacity_options, 'two-column'=>'second'),
					array( 'id'=>'image_url', 'type'=>'upload', 'name'=>'Main Image URL'),
				...
				), 'Content Slider', true, PEXETO_OPTIONS_PAGE, 'image_url|bg_image_url', PEXETO_SLIDER_TYPE, 'slider-content.php', true ),
...
if ( !defined( 'PEXETO_UPDATE_XML_FILE' ) )
	define( 'PEXETO_UPDATE_XML_FILE', 'http://pexeto.com/updates/mineral.xml' );
