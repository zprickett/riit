		...
		$pexeto->meta = array(
			...
			'page'=> array(
				...
				array(
					...
					&raquo; Pages &raquo; "Display page title" field will be used.',
					'data' => array( 'template' => 'default,template-contact.php,template-blog.php,template-archive.php,template-full-custom.php' ),
				),

				array(
					'name' => 'Display Page Title',
					'id' => PEXETO_META_PREFIX.'pg_show_title',
					'type' => 'select',
					'options' => array(
						array( 'name'=>'Use Global Settings', 'id'=>'global' ),
						array( 'name'=>'Display', 'id'=>'on' ),
						array( 'name'=>'Hide', 'id'=>'off' ) ),
					'std' => 'off',
					'desc' => 'If "Use Global Settings" selected, the global setting selected in 
					the '.PEXETO_THEMENAME.' Options &raquo; Post &amp; Page Settings 
					&raquo; Pages &raquo; "Display page title" field will be used.',
